...
public class Laboratory implements Serializable, Comparable<Laboratory> {
       ...
       *
       * @param laboratory object of class {@code Laboratory}
      ...
      public int compareTo(Laboratory laboratory) {
            ...
            return Difficulty.compare(this.difficulty, laboratory.getDifficulty());
      }
      ...
      public String toString() {
            return
                    ...
                    "\tpersonal qualities minimum: " + this.personalQualitiesMinimum + "\n" +
                    "\ttuned in works: "             + this.tunedInWorks + "\n" +
                    "\tdifficulty -> "               + this.difficulty + "\n" +
                    "\t"                             + this.discipline.toString();
      }
}
